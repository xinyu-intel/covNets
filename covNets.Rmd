...
Then, we will build a 3-layer covNets in R language. A three-layer convolutional network with the 
...
samp_train <- sample(1:60000,100)
samp_test <- sample(1:10000,30)
